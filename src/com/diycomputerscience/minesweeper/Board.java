...
public class Board {
	...
	public Board(MineInitializationStrategy mineInitializationStrategy) {
		...
		// TODO: Use the mineInitializationStrategy to set mines in required
		// squares
		List<Point> mines = mineInitializationStrategy.mines(new Point(
				Board.MAX_ROWS, Board.MAX_COLS));
